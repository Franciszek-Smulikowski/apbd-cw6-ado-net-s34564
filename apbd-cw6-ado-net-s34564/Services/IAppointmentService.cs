...
public class AppointmentOperationResult
{
    ...
    {
        return new AppointmentOperationResult { Status = AppointmentOperationStatus.BadRequest, ErrorMessage = message };
    }

    public static AppointmentOperationResult NotFound(string message)
    {
        return new AppointmentOperationResult { Status = AppointmentOperationStatus.NotFound, ErrorMessage = message };
    }

    public static AppointmentOperationResult Conflict(string message)
    {
        return new AppointmentOperationResult { Status = AppointmentOperationStatus.Conflict, ErrorMessage = message };
    }
}
...
public class AppointmentOperationResult<T> : AppointmentOperationResult
{
    ...
    {
        return new AppointmentOperationResult<T> { Status = AppointmentOperationStatus.BadRequest, ErrorMessage = message };
    }

    public new static AppointmentOperationResult<T> NotFound(string message)
    {
        return new AppointmentOperationResult<T> { Status = AppointmentOperationStatus.NotFound, ErrorMessage = message };
    }

    public new static AppointmentOperationResult<T> Conflict(string message)
    {
        return new AppointmentOperationResult<T> { Status = AppointmentOperationStatus.Conflict, ErrorMessage = message };
    }
}
